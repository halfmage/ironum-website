...
Ein **Chatbot** beantwortet die Frage "Wie ist der Status meiner Bestellung?" Ein **KI-Agent** erkennt, dass eine Lieferung verspätet ist, informiert den Kunden proaktiv, benachrichtigt den Vertrieb und passt die Lieferprognose im ERP-System an. Für die meisten Mittelständler ist der saubere Erstschritt der Chatbot — ein Praxisleitfaden zur [DSGVO-konformen Chatbot-Einführung auf eigenen Daten](/de/ressourcen/blog/chatbot-eigene-daten-dsgvo-mittelstand/) zeigt Architektur, Kosten und Vier-Wochen-Plan.
