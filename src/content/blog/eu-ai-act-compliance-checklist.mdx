...
**Limited risk:** Systems with specific transparency obligations, such as chatbots (must disclose they are AI), emotion recognition systems, and deepfake generators. If your deployment involves a customer- or employee-facing chatbot on your own data, our [GDPR-compliant chatbot playbook for SMEs](/resources/blog/chatbot-own-data-gdpr-sme/) covers the Art. 50 transparency duty alongside the broader GDPR architecture.
