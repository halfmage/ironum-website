...
faq:
  ...
  - question: "Can I build a GDPR-compliant HR chatbot?"
    answer: "Yes — an internal HR chatbot (employee self-service assistant) is one of the most common deployments. It answers questions on leave, onboarding, and company policies by reading only your own HR handbook and intranet, on EU-hosted infrastructure, so no employee data leaves European jurisdiction. Keep it sound the same way as any internal bot: an open-source model on European servers, a defined retention period for chat logs, and SSO so only employees can reach it. Because employees use it, involve your works council and data protection officer early."
...
### 2. Microsoft Teams or Slack as an internal HR and IT helpdesk

This is the classic **HR chatbot** — an employee self-service assistant. Employees ask "how do I book special leave", "what is our parental-leave policy", or "where is the latest onboarding plan" directly in Teams, and the bot answers from the HR handbook, IT documentation, and Confluence. Integration goes via the Teams Bot Framework or a Slack app; authentication runs through your existing SSO or Entra ID. No additional login, no shadow IT.

The practical value is that standard questions get answered around the clock instead of next business day, which reduces the load on HR and IT helpdesks for recurring queries. Because the answers come only from your own internal documents on European infrastructure, no employee data leaves your jurisdiction. As with any internal bot, set a retention period for chat logs and involve your works council and data protection officer early (see the FAQ below).
...
**Can I build a GDPR-compliant HR chatbot?**
Yes — an internal HR chatbot (employee self-service assistant) is one of the most common deployments. It answers questions on leave, onboarding, and company policies by reading only your own HR handbook and intranet, on EU-hosted infrastructure, so no employee data leaves European jurisdiction. Keep it sound the same way as any internal bot: an open-source model on European servers, a defined retention period for chat logs, and SSO so only employees can reach it. Because employees use it, involve your works council and data protection officer early (see the next question).
