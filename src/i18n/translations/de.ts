export const de = {
  ...
  homepage: {
    ...
    industriesEyebrow: 'BRANCHEN, DIE WIR KENNEN',
    industriesTitle: 'KI rund um die echten Anwendungsfälle Ihrer Branche',
    industriesSubtitle: 'Wir starten bei Problemen, die wir mit Kunden in Ihrer Branche bereits gelöst haben, nicht bei einer Standardvorlage. Bereitgestellt auf Ihrer Infrastruktur, in Ihrer Region.',
    industriesCta: 'Anwendungsfälle ansehen',
    industryCards: [
      { name: 'Recht', description: 'Vertragsprüfung, NDA-Triage und juristische Q&A über Ihre Akten hinweg, mit voller Mandantenvertraulichkeit, weil nichts Ihre Infrastruktur verlässt.', href: '/de/branchen/recht/' },
      { name: 'Fertigung', description: 'Predictive Maintenance, Qualitätsprüfung und Wissenssuche für die Fertigung, verbunden mit den Systemen, die Ihre Produktion bereits steuern.', href: '/de/branchen/fertigung/' },
      { name: 'Finanzdienstleistungen', description: 'Betrugserkennung, KYC/AML-Automatisierung und Risikomodellierung auf Daten, die in Ihrer Umgebung und Ihrem regulatorischen Rahmen bleiben.', href: '/de/branchen/finanzdienstleistungen/' },
      { name: 'Bildung', description: 'White-Label-KI-Tutoren und Prüfungsvorbereitung, die das Lernen personalisieren und Lernendendaten vollständig unter Ihrer Kontrolle halten.', href: '/de/branchen/bildung/' },
      { name: 'Gesundheitswesen', description: 'Dokumentationsassistenz, Verwaltungsautomatisierung und klinisches Wissensmanagement. Patientendaten verlassen nie Ihre Infrastruktur.', href: '/de/branchen/gesundheitswesen/' },
      { name: 'Öffentlicher Sektor', description: 'Assistenten für Bürgerdienste, Dokumentenverarbeitung und interne Wissenssuche, bereitgestellt auf Infrastruktur, die Sie verwalten.', href: '/de/branchen/oeffentlicher-sektor/' },
    ],
    complianceEyebrow: 'VERTRAUEN & DATENHOHEIT',
    complianceTitle: 'Ihre Daten bleiben Ihre Daten',
    complianceSubtitle: 'Der Grund, private KI zu bauen, statt Ihr Geschäft in eine öffentliche ChatGPT-API zu leiten: Sie behalten die Kontrolle über Ihre Daten, Ihre Kosten und Ihre Compliance.',
    complianceCards: [
      { title: 'Läuft in Ihrer Umgebung', description: 'Bereitstellung on-premise, in Ihrer Private Cloud oder in einer Region Ihrer Wahl. Ihre Dokumente und Anfragen verlassen nie die Infrastruktur, die Sie kontrollieren.' },
      { title: 'DSGVO-konform by Design', description: 'Auftragsverarbeitungsverträge, Audit-Protokolle und EU-KI-Verordnungs-Dokumentation inklusive. Compliance ist Standard, kein kostenpflichtiges Add-on.' },
      { title: 'Keine Abhängigkeit, keine Per-Abfrage-Kosten', description: 'Aufgebaut auf Open-Source-Modellen, die Ihnen gehören. Keine überraschenden API-Gebühren, keine Herstellerabhängigkeit. Jederzeit vollständig ins Haus holbar.' },
    ],
